...
def createMap():
  ...
  map.add_edge(rtPavillionPark, hub, 3.6)
  map.add_edge(rtPavillionPark, peaceGarden, 13.0)
  map.add_edge(rtPavillionPark, sugarHouse, 7.4)
  map.add_edge(rtPavillionPark, sugarHouse, 10.1)
  map.add_edge(rtPavillionPark, healthServices, 5.5)
  map.add_edge(rtPavillionPark, publicWorks, 7.2)
  map.add_edge(rtPavillionPark, streetsAndSanitation, 14.2)
  map.add_edge(rtPavillionPark, dekerLake, 10.7)
  map.add_edge(rtPavillionPark, ottingerHall, 14.1)
  map.add_edge(rtPavillionPark, columbusLibrary, 6.0)
  map.add_edge(rtPavillionPark, taylorsvilleCityHall, 6.8)
  map.add_edge(rtPavillionPark, southSaltPolice, 6.4)
  map.add_edge(rtPavillionPark, councilHall, 14.1)
  map.add_edge(rtPavillionPark, redwoodPark, 10.5)
  map.add_edge(rtPavillionPark, slcMentalHealth, 8.8)
  map.add_edge(rtPavillionPark, slcPolice, 8.4)
  map.add_edge(rtPavillionPark, westValleyProsecutor, 13.6)
  map.add_edge(rtPavillionPark, slcHousingAuth, 5.2)
  map.add_edge(rtPavillionPark, dmv, 6.9)
  map.add_edge(rtPavillionPark, juvenileCourt, 13.1)
  map.add_edge(rtPavillionPark, cottonwoodSoftball, 4.1)
  map.add_edge(rtPavillionPark, holidayCityOffice, 4.7)
  map.add_edge(rtPavillionPark, murrayMuseum, 3.1)
  map.add_edge(rtPavillionPark, vrSoftball, 7.8)
  map.add_edge(rtPavillionPark, rockSprings, 1.3)
  map.add_edge(rtPavillionPark, rtPavillionPark, 8.3)
